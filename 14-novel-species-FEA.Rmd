...
- For `3) provide identifiers` return to `RStudio`, copy the list of genes from the file `workshop/Axolotl_background.txt` and paste them into the `list of gene/protein names` field
- Ensure that `enable usage as a statistical background` is checked at `4) set additional options...`

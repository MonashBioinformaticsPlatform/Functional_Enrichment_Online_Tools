...
You have previosuly been provided with an RStudio VM. These have all the required R packages for today's activities.

<p>&nbsp;</p>  <!-- insert blank line -->

&#x27A4; Open the RStudio VM using the login details provided to you.

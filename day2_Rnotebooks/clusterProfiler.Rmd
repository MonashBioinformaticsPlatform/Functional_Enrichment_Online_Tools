...
- view the table, can put in ecel for cusotm filters, get genes etc
...
cnetplot(gsea_kegg, showCategory = 15, cex_label_gene = 0.5, cex_label_category = 0.8, colorEdge = TRUE, node_label = "category")

# node_label = one of ’all’, ’none’, ’category’ and ’item’
# cnetplot(gsea_kegg, showCategory = 15, cex_label_gene = 0.5, cex_label_category = 0.8, colorEdge = TRUE, node_label = "item")
#cnetplot(gsea_kegg, showCategory = 15, cex_label_gene = 0.5, cex_label_category = 0.8, colorEdge = TRUE, node_label = "category")
...
## treeplot
 ...
 - need to research more on what this tree does - consider cull if not clear  

...
- Can be used for novel species
- Supports many namespaces (73) 
...
- Supports many databases/gene sets (70) including 'nonredundant' versions of GO
...
4. Customise visualisation of WebGestaltR results with `enrichplot`

...
The same authors have released a companion plotting package [enrichplot](https://www.bioconductor.org/packages/release/bioc/html/enrichplot.html) dedicated to plotting enrichment results. 
...
3. `clusterProfiler` functions (`get_wp_organisms()`, `keytypes(org.Hs.eg.db)`)
